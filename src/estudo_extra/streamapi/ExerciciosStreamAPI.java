package estudo_extra.streamapi;
...
//                .forEach(System.out::println);
        ...
        Set<String> numerosAleatorios5PrimeirosSet = numerosAleatorios.stream()
                .limit(5)
                .collect(Collectors.toSet());
        System.out.println(numerosAleatorios5PrimeirosSet);
        
        List<String> numerosAleatorios5PrimeirosList = numerosAleatorios.stream()
                .limit(5)
                .collect(Collectors.toList());
        System.out.println(numerosAleatorios5PrimeirosList);
