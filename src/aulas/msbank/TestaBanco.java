...
//		String dataDeAdmissao = LocalDate.now().format(dataFormatada);
		Gerente funcionario = new Gerente("Mariana", "001.122.348-92", "99988 SSP RO",
				LocalDate.now(),2000.0);
		
		System.out.println(funcionario.toString());
		
		boolean resposta = funcionario.autenticarSistema("admin", "admin");
		System.out.println(resposta);
		
		boolean resposta1 = funcionario.autenticarSistema("usuariopadrao", "123");
		System.out.println(resposta1);
		
		funcionario.alterarSenha("usuariopadrao", "123", "456789125");
		
		funcionario.alterarUsuario("admin", "123", "456");
		
		funcionario.alterarUsuario("admin", "1234", "456");
		
		funcionario.alterarSenha("usuariopadrao", "1234", "456");
		...
		//Depois de criar funcionário criar classes Diretor e Gerente e estender da classe Funcionário
